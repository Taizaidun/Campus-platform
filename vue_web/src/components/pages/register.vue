  ...
  <div class="registerDivClass">
    <el-card shadow="always" style="top:50px;margin: 0 auto;width: 29%;min-height: 650px;position: relative;">
      ...
      <div style="text-align: center;margin-left: 20px;margin-top: 50px;">
        <el-input placeholder="请输入用户名，纯字母 3-10 位" v-model="inputUsername" clearable maxlength="10"
                  show-word-limit>
        ...
        <el-input placeholder="数字 + 字母（支持特殊符号），至少 3 位" style="margin-top: 30px;" v-model="inputPassword" show-password maxlength="30"
                  show-word-limit>
